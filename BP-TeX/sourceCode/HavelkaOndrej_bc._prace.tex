...
Ve druhé kapitole budou představeny definice, se kterými se bude v práci pracovat. V první podkapitole to budou 2 speciální funkce, gama funkce a následně Mittag-Lefflerova funkce. Věty uvádějící vztahy speciálních funkcí budou zde udány bez důkazu. Ty je možné najít v \cite{Podlubny} a v literatuře tam uvedené.
