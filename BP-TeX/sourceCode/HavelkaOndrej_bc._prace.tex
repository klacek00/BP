...
%TODO objasnit jestli l'Hospital malé nebo velké L
...
%todo jak vyřešit odsazení na více místech v textu
...
Jako příklad lze uvést funkci $y\left(t\right) =  \cos{\left(t\right)}$ na intervalu $\left\langle 0, 2\pi \right\rangle$. Pro levou a pravou Riemann-Liouvillovu nultou derivaci platí:%TODO chyba texu při sázení pomlčky na konec řádku
%\begin{equation} 
...
Řešení počátečního problému pro diferenciální rovnice se v numerickém počtu zjednodušuje na problém diferenčních rovnic. V každém kroku $n$ o velikosti $\tau$ tohoto zjednodušení dochází k chybě. V numerické matematice zavádíme několik druhů chyb. %TODO zavést síť tau
...
%\end{defin} 
%TODO lte přenechat až ke každé metodě zvlášť a zde jen zmínit, že existuje
...
Mezi nejzákladnější metody řešení počátečních úloh diferenciálních rovnic  patří Eulerovy metody. Zavedení těchto numerických metod je zavedeno monografií \cite{Cangpin}. Stejně je tomu i u zlomkového kalkulu, pouze s malými rozdíly.
...
%TODO podle současného číslování
